...
import { ButtonVariants, HlmButtonImports } from '@dots-beacon/ui/button'
import { HlmPopoverTrigger } from '@dots-beacon/ui/popover'
import { hlm } from '@dots-beacon/ui/utils'
...
export class HlmDatePickerTrigger implements HlmDatePickerTriggerBase {
    ...
    protected readonly _computedClass = computed(() =>
        hlm(
            'data-placeholder:text-muted-foreground w-64 justify-between',
            this.userClass()
        )
    )
